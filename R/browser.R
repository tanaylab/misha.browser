...
#' @param plot_type Plot type: "line", "line_points", "area", "point",
#'   "histogram", "segment". "line_points" draws a line through the data
#'   plus constant-size dots at each measurement, useful for sparse
#'   per-position signals like WGBS methylation fraction.
